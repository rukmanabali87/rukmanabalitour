                    ...
                    <div className="lg:w-2/5">
                        <div className="relative overflow-hidden rounded-md bg-white dark:bg-slate-900 shadow dark:shadow-gray-800">
                            ...
                            <div className="px-6 py-12 text-center">
                                ...
                                <div className="mt-6">
                                    <Link href="/" className="py-2 px-5 inline-block tracking-wide align-middle duration-500 text-base text-center bg-primary text-white rounded-md">Continue</Link>
                                </div>
                            </div>
