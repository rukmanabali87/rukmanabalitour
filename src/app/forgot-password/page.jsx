                        ...
                        <div className="grid grid-cols-1">
                            ...
                            <form className="text-start">
                                <div className="grid grid-cols-1">
                                    ...
                                    <div className="mb-4">
                                        <input type="submit" className="py-2 px-5 inline-block tracking-wide align-middle duration-500 text-base text-center bg-primary text-white rounded-md w-full" value="Send" required/>
                                    </div>
