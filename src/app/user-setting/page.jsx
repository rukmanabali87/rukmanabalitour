            ...
            <div className="container relative md:mt-24 mt-16">
                <div className="md:flex">
                    ...
                    <div className="lg:w-3/4 md:w-2/3 md:px-3 mt-6 md:mt-0">
                        <div className="p-6 rounded-md shadow dark:shadow-gray-800 bg-white dark:bg-slate-900">
                            ...
                            <form>
                                <div className="grid lg:grid-cols-2 grid-cols-1 gap-5">
                                    <div>
                                        <label className="form-label font-medium">First Name : <span className="text-primary-600">*</span></label>
                                    ...
                                    <div>
                                        <label className="form-label font-medium">Last Name : <span className="text-primary-600">*</span></label>
                                        <div className="form-icon relative mt-2">
                                    ...
                                    <div>
                                        <label className="form-label font-medium">Your Email : <span className="text-primary-600">*</span></label>
                                        <div className="form-icon relative mt-2">
                                ...
                                <input type="submit" id="submit" name="send" className="py-2 px-5 inline-block font-semibold tracking-wide align-middle duration-500 text-base text-center bg-primary text-white rounded-md mt-5" value="Save Changes"/>
                            </form>
                        </div>
                            ...
                            <div className="grid lg:grid-cols-2 grid-cols-1 gap-5">
                                <div>
                                    ...
                                    <form>
                                        ...
                                        <button className="py-2 px-5 inline-block font-semibold tracking-wide align-middle duration-500 text-base text-center bg-primary text-white rounded-md mt-5">Add</button>
                                    </form>
                                </div>
                                ...
                                <div> 
                                    ...
                                    <form>
                                        ...
                                        <button className="py-2 px-5 inline-block font-semibold tracking-wide align-middle duration-500 text-base text-center bg-primary text-white rounded-md mt-5">Save password</button>
                                    </form>
                                </div>
                        ...
                        <div className="p-6 rounded-md shadow dark:shadow-gray-800 bg-white dark:bg-slate-900 mt-6">
                            <h5 className="text-lg font-semibold mb-5 text-primary-600">Delete Account :</h5>

                            <p className="text-slate-400 mb-4">Do you want to delete the account? Please press below "Delete" button</p>

                            <Link href="" className="py-2 px-5 inline-block font-semibold tracking-wide align-middle duration-500 text-base text-center bg-primary-600 text-white rounded-md">Delete</Link>
                        </div>
                    </div>
                </div>
            </div>
