                ...
                <div className="grid grid-cols-1 pb-8 text-center mt-10">
                    ...
                    <div className="text-center subcribe-form mt-4 pt-2">
                        <form className="relative mx-auto max-w-xl">
                            ...
                            <button type="submit" className="py-2 px-5 inline-block font-semibold tracking-wide align-middle duration-500 text-base text-center absolute top-[2px] end-[3px] h-[46px] bg-primary text-white rounded-full">Search</button>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <section className="relative md:py-24 py-16">
            ...
            <div className="container relative md:mt-24 mt-16">
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 mt-8 gap-6">
                    <div className="flex">
                        <FiHelpCircle className="fea icon-ex-md text-primary me-3 mt-1 size-6"></FiHelpCircle>
                        <div className="flex-1">
                            <h5 className="mb-2 text-xl font-semibold">How our <span className="text-primary">Travosy</span> work ?</h5>
                    ...
                    <div className="flex">
                        <FiHelpCircle className="fea icon-ex-md text-primary me-3 mt-1 size-6"></FiHelpCircle>
                        <div className="flex-1">
                            <h5 className="mb-2 text-xl font-semibold"> Is <span className="text-primary">Travosy</span> safer to use with my account ?</h5>
