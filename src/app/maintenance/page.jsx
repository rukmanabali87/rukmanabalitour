...
export default function Maintence(){
    ...
    return(
        <>
          <section className="relative h-screen flex items-center justify-center text-center bg-[url('/images/bg/cta.jpg')] bg-no-repeat bg-center bg-cover">
            <div className="absolute inset-0 bg-slate-900/25"></div>
            <div className="absolute inset-0 bg-gradient-to-b from-transparent via-black/40 to-black"></div>
            <div className="container relative">
                <div className="grid grid-cols-1">
                    <Image src='/images/logo-light.png' width={133} height={28} className="mx-auto" alt=""/>
                ...
                <div className="grid grid-cols-1 mt-6">
                    <div className="text-center subcribe-form">
                        <form className="relative mx-auto max-w-xl">
                            ...
                            <button type="submit" className="py-2 px-5 inline-block font-semibold tracking-wide align-middle duration-500 text-base text-center absolute top-[2px] end-[3px] h-[46px] bg-primary text-white rounded-full">Subcribe Now</button>
                        </form>
                    </div>
                </div>
            </div>
