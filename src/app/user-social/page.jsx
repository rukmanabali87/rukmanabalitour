                            ...
                            <div className="p-6">
                                ...
                                <div className="md:flex">
                                    <div className="md:w-1/3">
                                        ...
                                        <button className="py-2 px-5 inline-block font-semibold tracking-wide align-middle duration-500 text-base text-center bg-primary text-white rounded-md mt-5">Save Social Profile</button>
                                    </div>
                                </div>
                            </div>
                        </div>
