                            ...
                            <div className="grid lg:grid-cols-2 grid-cols-1 gap-6 mt-6">
                                <div className="">
                                    <div className="flex items-center mb-4 justify-between">
                                        ...
                                        <Link href="#" className="text-primary text-lg"><FiEdit className="size-4"/></Link>
                                    </div>
                                    <div className="pt-4 border-t border-gray-100 dark:border-gray-700">
                                        ...
                                        <ul className="list-none">
                                            ...
                                            <li className="flex mt-1">
                                                <FiPhone className="size-4 me-2 mt-1"/>
                                ...
                                <div className="">
                                    <div className="flex items-center mb-4 justify-between">
                                        ...
                                        <a href="#" className="text-primary text-lg"><FiEdit className="size-4"/></a>
                                    </div>
                                    <div className="pt-4 border-t border-gray-100 dark:border-gray-700">
                                        <p className="text-lg font-medium mb-2">Jesus Zamora</p>
