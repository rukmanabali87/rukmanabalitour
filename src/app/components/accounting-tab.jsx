...
import {FiAirplay, FiCreditCard, FiFileText, FiShare2, FiBell, FiSettings,FiLogOut, FiEdit} from 'react-icons/fi'
                    ...
                    <div className="border-t border-gray-100 dark:border-gray-700">
                        <ul className="list-none sidebar-nav mb-0 pb-0" id="navmenu-nav">
                            <li className={`navbar-item account-menu ${current === '/user-profile' ? 'active' : ''}`}>
                             ...
                             <li className={`navbar-item account-menu ${current === '/user-billing' ? 'active' : ''}`}>
                                <Link href="/user-billing" className="navbar-link text-slate-400 flex items-center py-2 rounded">
                                    ...
                                    <h6 className="mb-0 font-medium">Billing</h6>
                                </Link>
                            </li>
