                        ...
                        <ul className="list-none">
                            ...
                            <li className="inline-flex items-center ms-2">
                                <ul className="list-none space-x-3">
                                    ...
                                    <li className="inline-flex ms-2 mb-0"><a href="tel:+152534-468-854" className="text-slate-300 hover:text-primary"><FiPhone className="size-4 align-middle" title="phone"></FiPhone></a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
