                                ...
                                <div className="tiny-slide" key={index}>
                                    <div className="group text-center m-2">
                                        <div className="relative overflow-hidden rounded-full">
                                            <Image src={item.image} width={0} height={0} sizes="100vw" style={{width:'100%', height:'auto'}} className="w-full md:h-32 h-36 object-cover scale-125 group-hover:scale-100 duration-500 shadow dark:shadow-gray-800" alt=""/>
                                        </div>
        
                                        <div className="mt-2">
                                            <Link href="" className="text-lg font-medium hover:text-primary duration-500 ease-in-out">{item.place}</Link>
