                        ...
                        <div className="p-6 rounded-md shadow dark:shadow-gray-800 bg-white dark:bg-slate-900">
                            <div className="border-b border-gray-100 dark:border-gray-700 pb-6">
                                <div className="md:flex justify-between">
                                    <div>
                                        <Image src='/images/logo-dark.png' width={133} height={28} className="block dark:hidden" alt=""/>
                                        <Image src='/images/logo-light.png' width={133} height={28} className="hidden dark:block" alt=""/>
                                        <div className="flex mt-4">
                                            <FiLink className="size-4 me-3 mt-1"></FiLink>
                                            <Link href="#" target="_blank" className="text-primary dark:text-white font-medium">www.travosy.com</Link>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mt-6 md:mt-0 md:w-56">
                                        ...
                                        <ul className="list-none">
                                            ...
                                            <li className="flex mt-3">
                                                ...
                                                <Link href="mailto:contact@example.com" className="text-slate-400">info@Travosy.com</Link>
                                            </li>
                                ...
                                <div className="md:flex justify-between">
                                    <div>
                                        <div className="text-slate-400 text-center md:text-start">
                                            <h6 className="mb-0">Customer Services : <Link href="tel:+152534-468-854" className="text-primary">(+12) 1546-456-856</Link></h6>
                                        </div>
                                    </div>

                                    <div className="mt-4 md:mt-0">
                                        <div className="text-slate-400 text-center md:text-end">
                                            <h6 className="mb-0"><Link href="/terms" target="_blank" className="text-primary">Terms & Conditions</Link></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
